...
2. Select the 3-5 strongest brag entries that match the target role.
3. Convert each into a resume bullet using the format below.

## Resume Bullet Format

**[Action verb] [what you did] [for whom/what scope], [measurable result].**

### Examples

- Designed and shipped a blog-first career evidence system with typed metadata, automated capture sync, and AI-driven review workflows, reducing brag-doc maintenance from ad-hoc notes to a structured daily pipeline.
