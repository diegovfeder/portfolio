...
Canonical professional data that anchors all brag workflows.

Everything in this folder is **source data** — prompts, generators, and AI workflows read from here first. If the manifest is wrong, the outputs will be wrong.

## Files

- `profile.md` — Identity, stack, career timeline, skills inventory, career direction
